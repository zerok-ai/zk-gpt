...
RUN pyinstaller app/main.py --target-arch arm64 --onefile --name zk-gpt-arm64 --collect-all=langchain --collect-all=pinecone
RUN pyinstaller app/main.py --target-arch amd64 --onefile --name zk-gpt-amd64 --collect-all=langchain --collect-all=pinecone
